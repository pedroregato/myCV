...
→ Monitoramento e triagem processual via API DataJud/CNJ (Python · Streamlit): R$ 28M em economia de provisionamento contábil anual (reclassificação de risco jurídico), 4.980 processos saneados (2025), 3.765 sinalizados (1T2026)
